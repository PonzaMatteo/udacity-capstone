...
var require_package = __commonJS({
  "node_modules/winston/package.json"(exports2, module2) {
    module2.exports = {
      ...
      _spec: "winston",
      _where: "/Users/matteoponza/dev/udacity-capstone",
      author: {
  ...
  "node_modules/winston/lib/winston/transports/http.js"(exports2, module2) {
    ...
    module2.exports = class Http extends TransportStream {
      ...
      _request(options, callback) {
        options = options || {};
        const auth2 = options.auth || this.auth;
    ...
    module2.exports = class Container {
      ...
      add(id, options) {
        if (!this.loggers.has(id)) {
          ...
          const logger2 = createLogger3(options);
...
var require_winston = __commonJS({
  "node_modules/winston/lib/winston.js"(exports2) {
    ...
    Object.keys(winston2.config.npm.levels).concat([
      ...
      "configure",
      "child"
    ]).forEach((method) => winston2[method] = (...args2) => defaultLogger[method](...args2));
...
// src/libs/log/log.ts
var winston = __toModule(require_winston());
...
var AuthVerifier = class {
  constructor(cert, algo = ["RS256"]) {
    this.logger = createLogger2("auth-verifier");
  ...
  async verifyToken(authHeader) {
    ...
    const jwt = (0, import_jsonwebtoken.decode)(token, { complete: true });
    (0, import_jsonwebtoken.verify)(token, this.cert, { algorithms: this.algo });
  ...
  getTokenFromAuthHeader(authHeader) {
    ...
    if (!authHeader.toLowerCase().startsWith("bearer "))
      throw new Error("Invalid authentication header: it does not begin with `Bearer `");
...
// src/functions/auth/handler.ts
var logger = createLogger2("auth-handler");
var authorizer = new AuthVerifier(AUTH_CERTIFICATE);
