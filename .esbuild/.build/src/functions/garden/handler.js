...
// src/functions/garden/handler.ts
__export(exports, {
...
var createPlantHandler = async (event) => {
  return formatJSONResponse({
    message: {
      item: {
        userId: "user",
...
var getAllPlants = middyfy(plantsHandler);
var createPlant = middyfy(createPlantHandler);
